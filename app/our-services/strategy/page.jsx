        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center p-6 rounded-lg hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">
                Identify your benefits that not only differentiate you from the
                competition, but also set you apart.
              </p>
            </div>
          ...
          <div className="max-w-2xl mx-auto">
            <div className="bg-gray-50 rounded-lg p-8 text-center">
              ...
              <p className="text-gray-600 italic">
                "Being an entrepreneur is not easy. It's good to be able to talk
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="bg-white rounded-lg p-8 max-w-md mx-auto shadow-lg">
            ...
            <p className="text-gray-600">
              We've helped numerous companies achieve their strategic goals and
              sustainable growth.
            </p>
          </div>
        </div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <span>hello@sequency.ch</span>
                  </div>

                  <div className="flex items-center space-x-3">
                    <Phone className="text-blue-600" size={20} />
                    <span>+41 44 552 08 80</span>
                  </div>

                  <div className="flex items-start space-x-3">
                    <MapPin className="text-blue-600 mt-1" size={20} />
                    <div>
                      <div className="font-semibold">Sequency AG</div>
                      <div>Stehli-Seiden-Areal 11</div>
                      <div>8912 Obfelden, Zurich</div>
                      <div>Switzerland</div>
                    </div>
                  </div>
                </div>
              ...
              <div>
                ...
                <div className="bg-gray-50 p-6 rounded-lg">
                  <p className="text-gray-600 mb-4">
                    Ready to discuss your strategic goals? Contact us today to
                    schedule a consultation.
                  </p>
                  <div className="space-y-3">
                    <a
                      href="mailto:hello@sequency.ch"
